...
import { getTaskListManagerData, setTaskListManagerData } from './actions';
import { selectTaskListDataManager } from './selectors';
...
const TaskListManager = ({ taskListSelect }) => {
  ...
  useEffect(() => {
    dispatch(getTaskListManagerData());
  }, [dispatch]);
...
const mapStateToProps = createStructuredSelector({
  taskListSelect: selectTaskListDataManager,
});

export default connect(mapStateToProps)(TaskListManager);